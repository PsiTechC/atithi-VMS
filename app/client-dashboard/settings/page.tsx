...
export default function SettingsPage() {
 ...
 const [newIdType, setNewIdType] = useState({ name: "", description: "", required: false })
  ...
  const [newAccessPoint, setNewAccessPoint] = useState({ name: "", description: "", location: "", active: true })
  ...
  const handleAddAccessPoint = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setNewAccessPoint({ name: "", description: "", location: "", active: true })
  ...
  const handleEditAccessPoint = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`/api/client/settings/access-points/${editingAccessPoint._id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(editingAccessPoint)
      })
...
//   email: string
//   phone: string
//   imageUrl?: string // NEW: uploaded image
//   isActive?: boolean // NEW: active/inactive
//   bloodGroup?: string // NEW: blood group
//   approvalRequired?: boolean // NEW: approval required
//   createdAt: string
...
//       const isFirstSet = !passwordForm.currentPassword?.trim() // empty => first-time set
//       const endpoint = isFirstSet ? "/api/client/settings/set-password" : "/api/client/settings/change-password"
...
//         <div className="space-y-2">
//           <div className="relative">
//             <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-transparent p-8 rounded-2xl border border-primary/20 mb-8">
//               <h1 className="text-4xl font-bold bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
//                 Settings
//               </h1>
//               <p className="text-muted-foreground font-medium text-lg mt-2">
//                 Configure your client portal settings and preferences
//               </p>
//             </div>
//           </div>
...
//             //   <AlertDescription className="text-green-800">{success}</AlertDescription>
//             // </Alert>
//             <Alert className="border-secondary/30 bg-secondary/10 backdrop-blur-sm rounded-xl">
//               <CheckCircle className="h-4 w-4 text-secondary" />
//               <AlertDescription className="text-secondary-foreground font-medium">{success}</AlertDescription>
//             </Alert>
//           )}
...
//             <Alert
//               variant="destructive"
//               className="bg-destructive/10 border-destructive/30 backdrop-blur-sm rounded-xl"
//             >
//               <AlertCircle className="h-4 w-4" />
...
//             <div className="bg-card/50 backdrop-blur-sm p-2 rounded-2xl border border-border/50 shadow-lg">
//               <TabsList className="grid w-full grid-cols-8 bg-transparent gap-1 p-1">
//                 <TabsTrigger
//                   value="hosts"
//                   className="flex items-center gap-2 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-lg rounded-xl font-semibold transition-all duration-200 hover:bg-primary/10"
//                 >
//                   <Users className="h-4 w-4" />
...
//                 >
//                   <CreditCard className="h-4 w-4" />
//                   <span className="hidden sm:inline">ID Types</span>
//                 </TabsTrigger>
//                 <TabsTrigger
//                   value="purposes"
//                   className="flex items-center gap-2 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-lg rounded-xl font-semibold transition-all duration-200 hover:bg-primary/10"
...
//                 >
//                   <UserCheck className="h-4 w-4" />
//                   <span className="hidden sm:inline">Visitor Types</span>
//                 </TabsTrigger>
//                 <TabsTrigger
//                   value="access-points"
//                   className="flex items-center gap-2 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-lg rounded-xl font-semibold transition-all duration-200 hover:bg-primary/10"
//                 >
//                   <MapPin className="h-4 w-4" />
//                   <span className="hidden sm:inline">Access Points</span>
//                 </TabsTrigger>
//                 <TabsTrigger
//                   value="security"
//                   className="flex items-center gap-2 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-lg rounded-xl font-semibold transition-all duration-200 hover:bg-primary/10"
...
//                     />
//                     {newHost.imageUrl ? (
//                       <img src={newHost.imageUrl || "/placeholder.svg"} alt="Preview" className="h-16 w-16 rounded-full object-cover mt-2" />
//                     ) : (
//                       <p className="text-xs text-muted-foreground">PNG/JPG, up to ~2MB recommended.</p>
//                     )}
//                   </div>
...
//                       Add employees who can host visitors
//                     </CardDescription>
//                   </CardHeader>
//                   <CardContent className="p-6">
//                     <form onSubmit={handleAddHost} className="space-y-6">
//                       <div className="space-y-3">
//                         <Label htmlFor="host-name" className="text-sm font-semibold text-foreground">
//                           Full Name *
//                         </Label>
//                         <Input
//                           id="host-name"
...
//                           onChange={(e) => setNewHost({ ...newHost, name: e.target.value })}
//                           required
//                           className="h-12 rounded-xl border-border/50 bg-input/50 backdrop-blur-sm focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200"
//                           placeholder="Enter full name"
//                         />
//                       </div>
//                       <div className="space-y-3">
//                         <Label htmlFor="host-department" className="text-sm font-semibold text-foreground">
//                           Department
//                         </Label>
//                         <Input
//                           id="host-department"
...
//                       </div>
//                       <div className="space-y-3">
//                         <Label htmlFor="host-email" className="text-sm font-semibold text-foreground">
//                           Email Address
//                         </Label>
//                         <Input
//                           id="host-email"
...
//                       </div>
//                       <div className="space-y-3">
//                         <Label htmlFor="host-phone" className="text-sm font-semibold text-foreground">
//                           Phone Number
//                         </Label>
//                         <Input
//                           id="host-phone"
...
//                         type="submit"
//                         disabled={loading}
//                         className="w-full h-12 bg-gradient-to-r from-secondary to-secondary/80 hover:from-secondary/90 hover:to-secondary/70 text-secondary-foreground font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200"
//                       >
//                         {loading ? "Adding..." : "Add Host"}
//                       </Button>
//                     </form>
...
//                 {/* <p className="font-medium flex items-center gap-2">
//                               {host.imageUrl && (
//                                 <img src={host.imageUrl || "/placeholder.svg"} alt={host.name} className="h-8 w-8 rounded-full object-cover" />
//                               )}
...
//                 <Card className="bg-card/50 backdrop-blur-sm border-border/50 shadow-xl rounded-2xl overflow-hidden">
//                   <CardHeader className="bg-gradient-to-r from-primary/10 to-primary/5 border-b border-border/50">
//                     <CardTitle className="text-xl font-bold text-primary">Current Hosts</CardTitle>
//                     <CardDescription className="text-muted-foreground font-medium">
//                       Manage existing host employees
//                     </CardDescription>
//                   </CardHeader>
//                   <CardContent className="p-6">
...
//                         <div
//                           key={host._id}
//                           className="flex items-center justify-between p-4 bg-muted/30 backdrop-blur-sm border border-border/30 rounded-xl hover:bg-muted/50 transition-all duration-200"
//                         >
//                           <div className="flex-1">
//                             <p className="font-semibold text-foreground">{host.name}</p>
//                             <p className="text-sm text-muted-foreground font-medium">{host.department}</p>
//                             <p className="text-xs text-muted-foreground">{host.email}</p>
//                           </div>
//                           <div className="flex gap-2">
//                             <Button
...
//                               size="sm"
//                               onClick={() => setEditingHost(host)}
//                               className="rounded-lg border-primary/30 text-primary hover:bg-primary/10 hover:border-primary transition-all duration-200"
//                             >
//                               <Edit className="h-4 w-4" />
//                             </Button>
//                             <Button
...
//                               size="sm"
//                               onClick={() => handleDeleteHost(host._id, host.name)}
//                               className="rounded-lg border-destructive/30 text-destructive hover:bg-destructive/10 hover:border-destructive transition-all duration-200"
//                             >
//                               <Trash2 className="h-4 w-4" />
//                             </Button>
//                           </div>
...
//                     </CardTitle>
//                     <CardDescription className="text-muted-foreground font-medium">
//                       Add organizational departments
//                     </CardDescription>
//                   </CardHeader>
//                   <CardContent className="p-6">
//                     <form onSubmit={handleAddDepartment} className="space-y-6">
//                       <div className="space-y-3">
//                         <Label htmlFor="department-name" className="text-sm font-semibold text-foreground">
//                           Department Name *
//                         </Label>
//                         <Input
//                           id="department-name"
...
//                       </div>
//                       <div className="space-y-3">
//                         <Label htmlFor="department-description" className="text-sm font-semibold text-foreground">
//                           Description
//                         </Label>
//                         <Input
//                           id="department-description"
...
//                 <Card className="bg-card/50 backdrop-blur-sm border-border/50 shadow-xl rounded-2xl overflow-hidden">
//                   <CardHeader className="bg-gradient-to-r from-primary/10 to-primary/5 border-b border-border/50">
//                     <CardTitle className="text-xl font-bold text-primary">Current Departments</CardTitle>
//                     <CardDescription className="text-muted-foreground font-medium">
...
//                             {department.description && (
//                               <p className="text-sm text-muted-foreground font-medium">{department.description}</p>
//                             )}
//                           </div>
//                           <div className="flex gap-2">
//                             <Button
...
//                     </CardTitle>
//                     <CardDescription className="text-muted-foreground font-medium">
//                       Add job titles or designations for hosts
//                     </CardDescription>
//                   </CardHeader>
//                   <CardContent className="p-6">
//                     <form onSubmit={handleAddDesignation} className="space-y-6">
//                       <div className="space-y-3">
//                         <Label htmlFor="designation-name" className="text-sm font-semibold text-foreground">
//                           Designation Name *
//                         </Label>
//                         <Input
//                           id="designation-name"
...
//                       </div>
//                       <div className="space-y-3">
//                         <Label htmlFor="designation-description" className="text-sm font-semibold text-foreground">
//                           Description
//                         </Label>
//                         <Input
//                           id="designation-description"
...
//                 <Card className="bg-card/50 backdrop-blur-sm border-border/50 shadow-xl rounded-2xl overflow-hidden">
//                   <CardHeader className="bg-gradient-to-r from-primary/10 to-primary/5 border-b border-border/50">
//                     <CardTitle className="text-xl font-bold text-primary">Current Designations</CardTitle>
//                     <CardDescription className="text-muted-foreground font-medium">
...
//                         >
//                           <div className="flex-1">
//                             <p className="font-semibold text-foreground">{designation.name}</p>
//                             {designation.description && (
//                               <p className="text-sm text-muted-foreground font-medium">{designation.description}</p>
//                             )}
//                           </div>
//                           <div className="flex gap-2">
//                             <Button
...
//                     </CardTitle>
//                     <CardDescription className="text-muted-foreground font-medium">
//                       Add acceptable identification types for visitors
//                     </CardDescription>
//                   </CardHeader>
//                   <CardContent className="p-6">
//                     <form onSubmit={handleAddIdType} className="space-y-6">
//                       <div className="space-y-3">
//                         <Label htmlFor="id-type-name" className="text-sm font-semibold text-foreground">
//                           ID Type Name *
//                         </Label>
//                         <Input
//                           id="id-type-name"
...
//                       </div>
//                       <div className="space-y-3">
//                         <Label htmlFor="id-type-description" className="text-sm font-semibold text-foreground">
//                           Description
//                         </Label>
//                         <Input
//                           id="id-type-description"
...
//                         />
//                         <Label htmlFor="id-required" className="text-sm font-semibold text-foreground">
...
//                 <Card className="bg-card/50 backdrop-blur-sm border-border/50 shadow-xl rounded-2xl overflow-hidden">
//                   <CardHeader className="bg-gradient-to-r from-primary/10 to-primary/5 border-b border-border/50">
//                     <CardTitle className="text-xl font-bold text-primary">Current ID Types</CardTitle>
//                     <CardDescription className="text-muted-foreground font-medium">
//                       Manage acceptable identification types
//                     </CardDescription>
//                   </CardHeader>
//                   <CardContent className="p-6">
//                     <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
...
//                             <div>
//                               <p className="font-semibold text-foreground">{idType.name}</p>
//                               {idType.description && (
//                                 <p className="text-sm text-muted-foreground font-medium">{idType.description}</p>
//                               )}
//                             </div>
//                             {idType.required && (
//                               <Badge
//                                 variant="secondary"
//                                 className="bg-secondary/20 text-secondary border-secondary/30 font-medium"
//                               >
//                                 Required
//                               </Badge>
//                             )}
...
//                     </CardTitle>
//                     <CardDescription className="text-muted-foreground font-medium">
//                       Add visit purposes for better categorization
//                     </CardDescription>
//                   </CardHeader>
//                   <CardContent className="p-6">
//                     <form onSubmit={handleAddPurpose} className="space-y-6">
//                       <div className="space-y-3">
//                         <Label htmlFor="purpose-name" className="text-sm font-semibold text-foreground">
//                           Purpose Name *
//                         </Label>
//                         <Input
//                           id="purpose-name"
...
//                       </div>
//                       <div className="space-y-3">
//                         <Label htmlFor="purpose-description" className="text-sm font-semibold text-foreground">
//                           Description
//                         </Label>
//                         <Input
//                           id="purpose-description"
...
//                 <Card className="bg-card/50 backdrop-blur-sm border-border/50 shadow-xl rounded-2xl overflow-hidden">
//                   <CardHeader className="bg-gradient-to-r from-primary/10 to-primary/5 border-b border-border/50">
//                     <CardTitle className="text-xl font-bold text-primary">Current Purposes</CardTitle>
//                     <CardDescription className="text-muted-foreground font-medium">
//                       Manage visit purposes and categories
//                     </CardDescription>
//                   </CardHeader>
//                   <CardContent className="p-6">
//                     <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
...
//                         >
//                           <div className="flex-1">
//                             <p className="font-semibold text-foreground">{purpose.name}</p>
//                             {purpose.description && (
//                               <p className="text-sm text-muted-foreground font-medium">{purpose.description}</p>
//                             )}
//                           </div>
//                           <div className="flex gap-2">
//                             <Button
...
//                     </CardTitle>
//                     <CardDescription className="text-muted-foreground font-medium">
//                       Define visitor categories with access levels
//                     </CardDescription>
//                   </CardHeader>
//                   <CardContent className="p-6">
//                     <form onSubmit={handleAddVisitorType} className="space-y-6">
//                       <div className="space-y-3">
//                         <Label htmlFor="visitor-type-name" className="text-sm font-semibold text-foreground">
//                           Visitor Type Name *
//                         </Label>
//                         <Input
//                           id="visitor-type-name"
...
//                       </div>
//                       <div className="space-y-3">
//                         <Label htmlFor="visitor-type-description" className="text-sm font-semibold text-foreground">
//                           Description
//                         </Label>
//                         <Input
//                           id="visitor-type-description"
...
//                       </div>
//                       <div className="space-y-3">
//                         <Label htmlFor="visitor-color" className="text-sm font-semibold text-foreground">
//                           Badge Color
//                         </Label>
//                         <select
//                           id="visitor-color"
//                           value={newVisitorType.color}
//                           onChange={(e) => setNewVisitorType({ ...newVisitorType, color: e.target.value })}
//                           className="w-full h-12 rounded-xl border-border/50 bg-input/50 backdrop-blur-sm focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 px-3"
//                         >
//                           <option value="blue">Blue</option>
//                           <option value="green">Green</option>
//                           <option value="orange">Orange</option>
...
//                       </div>
//                       <div className="space-y-3">
//                         <Label htmlFor="access-level" className="text-sm font-semibold text-foreground">
//                           Access Level
//                         </Label>
//                         <select
//                           id="access-level"
...
//                 <Card className="bg-card/50 backdrop-blur-sm border-border/50 shadow-xl rounded-2xl overflow-hidden">
//                   <CardHeader className="bg-gradient-to-r from-primary/10 to-primary/5 border-b border-border/50">
//                     <CardTitle className="text-xl font-bold text-primary">Current Visitor Types</CardTitle>
//                     <CardDescription className="text-muted-foreground font-medium">
//                       Manage visitor categories and access levels
//                     </CardDescription>
//                   </CardHeader>
//                   <CardContent className="p-6">
//                     <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
...
//                     </CardTitle>
//                     <CardDescription className="text-muted-foreground font-medium">
//                       Define entry/exit points for visitor tracking
//                     </CardDescription>
//                   </CardHeader>
//                   <CardContent className="p-6">
//                     <form onSubmit={handleAddAccessPoint} className="space-y-6">
//                       <div className="space-y-3">
//                         <Label htmlFor="access-point-name" className="text-sm font-semibold text-foreground">
//                           Access Point Name *
//                         </Label>
//                         <Input
//                           id="access-point-name"
...
//                       </div>
//                       <div className="space-y-3">
//                         <Label htmlFor="access-point-description" className="text-sm font-semibold text-foreground">
//                           Description
//                         </Label>
//                         <Input
//                           id="access-point-description"
...
//                       </div>
//                       <div className="space-y-3">
//                         <Label htmlFor="access-point-location" className="text-sm font-semibold text-foreground">
//                           Location
//                         </Label>
//                         <Input
//                           id="access-point-location"
...
//                           className="w-4 h-4 text-primary bg-input border-border rounded focus:ring-primary focus:ring-2"
//                         />
//                         <Label htmlFor="access-active" className="text-sm font-semibold text-foreground">
//                           Active
//                         </Label>
//                       </div>
//                       <Button
...
//                 <Card className="bg-card/50 backdrop-blur-sm border-border/50 shadow-xl rounded-2xl overflow-hidden">
//                   <CardHeader className="bg-gradient-to-r from-primary/10 to-primary/5 border-b border-border/50">
//                     <CardTitle className="text-xl font-bold text-primary">Current Access Points</CardTitle>
//                     <CardDescription className="text-muted-foreground font-medium">
//                       Manage facility entry and exit points
//                     </CardDescription>
//                   </CardHeader>
//                   <CardContent className="p-6">
//                     <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
...
//                           <div className="flex items-center gap-4 flex-1">
//                             <div
//                               className={`w-3 h-3 rounded-full ${point.active ? "bg-green-500" : "bg-gray-400"}`}
//                             ></div>
//                             <div>
//                               <p className="font-semibold text-foreground">{point.name}</p>
//                               {point.description && (
//                                 <p className="text-sm text-muted-foreground font-medium">{point.description}</p>
//                               )}
//                               {point.location && <p className="text-xs text-muted-foreground">{point.location}</p>}
//                             </div>
//                           </div>
//                           <div className="flex gap-2">
//                             <Button
...
//                     >
//                       <div className="space-y-3">
//                         <Label htmlFor="default-checkout-hour" className="text-sm font-semibold text-foreground">
//                           Default Checkout Hour
//                         </Label>
//                         <Input
//                           id="default-checkout-hour"
...
//               name: "color",
//               label: "Badge Color",
//               options: ["blue", "green", "orange", "purple", "yellow", "red"],
//             },
//             {
//               type: "select",
//               name: "accessLevel",
//               label: "Access Level",
//               options: ["Restricted", "Limited", "Standard", "Extended"],
//             },
//           ]}
//         />
...
//           loading={loading}
//           fields={[
//             { type: "text", name: "name", label: "Designation Name *", required: true },
//             { type: "text", name: "description", label: "Description" },
//           ]}
//         />
//         <EditDialog
